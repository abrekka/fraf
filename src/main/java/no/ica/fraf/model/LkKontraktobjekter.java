 ...
 * 
 */
public class LkKontraktobjekter extends BaseObject {
	 ...
	 */
	public LkKontraktobjekter(String objekt, Integer id, String nr, Date dato,
	...
	public boolean equals(final Object other) {
		if (!(other instanceof LkKontraktobjekter))
			return false;
		LkKontraktobjekter castOther = (LkKontraktobjekter) other;
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE)
				...
				.append("kontraktObjektNr", kontraktObjektNr)
				.append("kontraktObjekt", kontraktObjekt)
				.append("terminer", terminer).append("startDato", startDato)
				.append("sluttDato", sluttDato).toString();
	}
	...
	public LkKontraktobjekter kontraktObjektID(String id) {
		setKontraktObjektId(Integer.valueOf(id));
		return this;
	}

	public LkKontraktobjekter kontraktObjektNR(String nr) {
		setKontraktObjektNr(nr);
		return this;
	}

	public LkKontraktobjekter kontraktObjekt(String kontraktobjekt) {
		setKontraktObjekt(kontraktobjekt);
		return this;
	}

	public LkKontraktobjekter terminer(String terminer) {
		setTerminer(Integer.valueOf(terminer));
		return this;
	}

	public LkKontraktobjekter startDato(String startdato) throws ParseException {
		setStartDato(simpleDateFormat.parse(startdato));
		return this;
	}

	public LkKontraktobjekter sluttDato(String sluttdato) throws ParseException {
		if (!"0".equals(sluttdato)) {

			setSluttDato(simpleDateFormat.parse(sluttdato));
		}
		return this;
	}

	public LkKontraktobjekter aarsbeloep(String aarsbeloep) {
		setAarsBeloep(BigDecimal.valueOf(Long.valueOf(aarsbeloep)));
		return this;
	}

	public LkKontraktobjekter fakturabeloep(String fakturabeloep) {
		setFakturabeloep(BigDecimal.valueOf(Long.valueOf(fakturabeloep)));
		return this;
	}
