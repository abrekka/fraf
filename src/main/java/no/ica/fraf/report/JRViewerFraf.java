...
/**
 * Denne klassen er omtrent lik JRViewer for JasperReport. Det er gjort noen
 * tilpasninger mhp lagreknapp og utskruftknapp. Og Hvilke valg som kommer opp
 * ved valg av lagring er endret
 * 
 * @author abr99
 * 
 */
public class JRViewerFraf extends javax.swing.JPanel implements
		JRHyperlinkListener {
	 ...
	 * @throws JRException
	 */
	public JRViewerFraf(String fileName, boolean isXML) throws JRException {
		setScreenDetails();
	 ...
	 * @throws JRException
	 */
	public JRViewerFraf(InputStream is, boolean isXML) throws JRException {
		setScreenDetails();
	 ...
	 * @param jrPrint
	 */
	public JRViewerFraf(JasperPrint jrPrint) {
		setScreenDetails();
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		tlbToolBar.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT,
				0, 2));

		btnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/net/sf/jasperreports/view/images/save.GIF")));
		btnSave.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		btnPrint.setToolTipText(java.util.ResourceBundle.getBundle(
				"net/sf/jasperreports/view/viewer").getString("print"));
		...
		btnReload.setToolTipText(java.util.ResourceBundle.getBundle(
				"net/sf/jasperreports/view/viewer").getString("reload"));
		...
		btnFirst.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		btnPrevious.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		btnNext.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		btnLast.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		txtGoTo.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		btnActualSize.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		btnFitPage.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		btnFitWidth.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		btnZoomIn.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		btnZoomOut.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		cmbZoom.setToolTipText(java.util.ResourceBundle.getBundle(
		...
		lblPage.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(
				0, 0, 0)));
	...
	void btnSaveActionPerformed() {// GEN-FIRST:event_btnSaveActionPerformed
		...
		/*
		 * FileFilter jrprintFileFilter = new FileFilter() { public boolean
		 * accept(File file) { if (file.isDirectory()) return true;
		 * 
		...
		/*
		 * JRSaveContributor xlsSingleSheetSaver = null; try { Class
		 * xlsSingleSheetSaverClass =
		 * JRClassLoader.loadClassForName("net.sf.jasperreports.view.save.JRSingleSheetXlsSaveContributor");
		 * xlsSingleSheetSaver =
		 * (JRSaveContributor)xlsSingleSheetSaverClass.newInstance();
		 * fileChooser.addChoosableFileFilter(xlsSingleSheetSaver); } catch
		 * (Exception e) { }
		 */

		/*
		 * JRSaveContributor xlsMultipleSheetsSaver = null; try { Class
		 * xlsMultipleSheetsSaverClass =
		 * JRClassLoader.loadClassForName("net.sf.jasperreports.view.save.JRMultipleSheetsXlsSaveContributor");
		 * xlsMultipleSheetsSaver =
		 * (JRSaveContributor)xlsMultipleSheetsSaverClass.newInstance();
		 * fileChooser.addChoosableFileFilter(xlsMultipleSheetsSaver); } catch
		 * (Exception e) { }
		 */
		...
		/*
		 * JRSaveContributor xmlSaver = null; try { Class xmlSaverClass =
		 * JRClassLoader.loadClassForName("net.sf.jasperreports.view.save.JRXmlSaveContributor");
		 * xmlSaver = (JRSaveContributor)xmlSaverClass.newInstance();
		 * fileChooser.addChoosableFileFilter(xmlSaver); } catch (Exception e) { }
		 */

		/*
		 * JRSaveContributor xmlEmbeddedImagesSaver = null; try { Class
		 * xmlEmbeddedImagesSaverClass =
		 * JRClassLoader.loadClassForName("net.sf.jasperreports.view.save.JREmbeddedImagesXmlSaveContributor");
		 * xmlEmbeddedImagesSaver =
		 * (JRSaveContributor)xmlEmbeddedImagesSaverClass.newInstance();
		 * fileChooser.addChoosableFileFilter(xmlEmbeddedImagesSaver); } catch
		 * (Exception e) { }
		 */
		...
		if (retValue == JFileChooser.APPROVE_OPTION) {
			...
			try {
				/*
				 * if (fileFilter == jrprintFileFilter) { if
				 * (!file.getName().endsWith(".jrprint")) { file = new
				 * File(file.getAbsolutePath() + ".jrprint"); }
				 * 
				 * JRSaver.saveObject(jasperPrint, file); } else
				 */if (fileFilter instanceof JRSaveContributor) {
					 ...
					 * lowerCaseFileName.endsWith(".jrpxml") && xmlSaver != null ) {
	...
	void hyperlinkClicked(MouseEvent evt) {
		...
		try {
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(this, java.util.ResourceBundle
					.getBundle("net/sf/jasperreports/view/viewer").getString(
							"error.hyperlink"));
		}
	}
	...
	private void setPageIndex(int index) {
		...
		if (jasperPrint != null && jasperPrint.getPages() != null
			...
			lblStatus.setText(MessageFormat.format(java.util.ResourceBundle
					.getBundle("net/sf/jasperreports/view/viewer").getString(
							"page"), new Object[] { new Integer(pageIndex + 1),
	...
	protected void refreshPage() {
		...
		Dimension dim = new Dimension(
				(int) (jasperPrint.getPageWidth() * realZoom) + 8, // 2 from
				// border, 5
				// from
				// shadow
				// and 1
