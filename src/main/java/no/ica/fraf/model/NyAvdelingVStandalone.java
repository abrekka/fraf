...
public class NyAvdelingVStandalone extends BaseObject implements NyAvdelingVInterface {
	...
	public boolean equals(final Object other) {
		if (!(other instanceof NyAvdelingV))
			return false;
		NyAvdelingVStandalone castOther = (NyAvdelingVStandalone) other;
