 ...
 * 
 */
public class PanelNyAvdeling extends AbstractReportPanel {
	/**
	 * 
	 */
	 ...
	 * @param aReportFrame
	 */
	public PanelNyAvdeling(ReportFrame aReportFrame) {
		super(aReportFrame, ReportEnum.REPORT_NY_AVDELING);
	}
	...
	public Object doWork(Object[] params, JLabel labelInfo) {
		...
		List reportLines;
		NyAvdelingVDAO nyAvdelingVDAO = (NyAvdelingVDAO) ModelUtil
				.getBean("nyAvdelingVDAO");

		if (fromDate == null) {
			reportLines = nyAvdelingVDAO.getListData();
		} else {
			reportLines = nyAvdelingVDAO.findByDate(fromDate);
		}
