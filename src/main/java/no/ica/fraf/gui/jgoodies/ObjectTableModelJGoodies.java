 ...
 * 
 */
public class ObjectTableModelJGoodies extends AbstractTableAdapter {
	/**
	 * 
	 */
	 ...
	 * Slettede data
	 */
	private Vector<Object> deletedData = null;
	...
	private static final Logger logger = Logger
			.getLogger(ObjectTableModelJGoodies.class);
	 ...
	 * @param data
	 */
	public ObjectTableModelJGoodies(ObjectTableDef def,ListModel data) {
		super(data, def.getColumnNames());
		if (def != null) {
	...
	public Object getValueAt(int row, int column) {
		...
		try {
			if (columnClass.getName().equalsIgnoreCase(
				...
				if (numberFormat != null && objectValue != null) {
	 ...
	 */
	private Object executeMethod(Object object, String methodName) {
		try {
			Method method = null;
			Object methodResult;
	...
	public BigDecimal getSumColumn(int col) {
		...
		for (int i = 0; i < rowCount; i++) {
			sum = sum.add((BigDecimal) getValueAtNoFormat(i, col));
		}
		return sum;
	}
	...
	/*public void setData(Collection<?> newData) {
		...
		this.data = new Vector<Object>(newData);
		deletedData = null;
	 ...
	 * @param newData
	 */
	/*public void setData(Set<Object> newData) {
		if (newData == null) {
			data = null;
		} else {
			this.data = new Vector<Object>(newData);
	...
	/*public Object deleteRow(int index) {
		...
		if (deletedData == null) {
			deletedData = new Vector<Object>();
		}

		Object delObject = data.remove(index);
